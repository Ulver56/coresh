...
_Этот текст является черновиком. С радостью выслушаем ваши замечания. Контакты кураторов внизу._
...
- Кнопка "Запустить спринт" - вызывает базовый класс спринт-роутера.
...
При нажатии на кнопку "Лента" - выводятся последний ответ или ворос пользователя. Ниже - кнопки ">>" и "<<" на первой странице кнопка "<<" неактивна. 
...
При запуске спринт обращается к этому классу. Проверяется текущий шаг пользователя и в зависимости от него запускается базовый класс карточки с параметрами необходимыми для этого шага.
...
(если в режиме ожидания, вместо кнопки показывается сколько осталось времени до возможности начать)
Входные -
Принимаемые -
Обработка - 
Выходные - 
