...
Последовательность шагов указывается в базовом классе роутера спринта описанного выше. Каждый шаг расширяет базовый класс описывающий тип карточки. После завершения шага - в таблице юзера обновляется значение поля с текушим шагом и класс роутера запускает следующий шаг, либо, при необходимости повторяет текущий.

### Базовые классы Карточек ###

**Выбор языков**

Входные - языки пользователя с NULL. Параметры - отсутствуют. Обработка - пользователь указывает знает язык или нет. Выходные - для языка из карточки в базе указывается true или false.

**Опрос на типаж**
Входные - в базе ищется вопрос на типаж, для которого не найден ответ пользователя.
Параметры -отсутствуют.
Обработка - пользователь отвечает на один из TODO
Выходные - 
...
**Вопрос от Пользователя для Участников Сообщества**
Входные -
Принимаемые -
Обработка - 
Выходные - 
...
**Оценка Пользователем ответа Участника Сообщества**
Входные -
Принимаемые -
Обработка - 
Выходные - 

**Инфрмационная Карточка**
Входные -
Принимаемые -
Обработка - 
Выходные - 
