...
**IPVO(input, processing, view, output):** описание каждого элемента системы представляется в виде связаных логических блоков.
- "I" - Данные которые пользователь запрашивает у сервера прежде чем показать экран. 
- "P" - Обработка данных.
- "V" - Интерфейс взаимодействия с системой. 
- "O" - Обработка пользовательских данных.
